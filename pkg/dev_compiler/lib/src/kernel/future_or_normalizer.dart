...
DartType normalizeFutureOr(FutureOrType futureOr, CoreTypes coreTypes) {
  ...
  if (typeArgument is InterfaceType &&
    ...
    return InterfaceType(
        coreTypes.futureClass, futureOr.nullability, [typeArgument]);
  } else if (typeArgument is NullType) {
    // FutureOr<Null> --> Future<Null>?
    return InterfaceType(
        coreTypes.futureClass, Nullability.nullable, [typeArgument]);
